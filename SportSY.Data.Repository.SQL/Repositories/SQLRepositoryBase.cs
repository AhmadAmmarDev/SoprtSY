...
namespace SportSY.Data.Repository.SQL.Repositories
{
	...
	{
		public SQLRepositoryBase(ApplicationDbContext _db)
		{
		...
		public virtual void DeleteItem(TModel existItem)
		{
		...
		public virtual TModel GetItemById(TModel item)
		{
	...
	{
		public StaticRepositoryBase(ApplicationDbContext _db) : base(_db)
		{
		}
		...
		public override void DeleteItem(TModel existItem)
		{
			base.DeleteItem(existItem);
			// ItemsList.ToList().Remove(existItem);
		}
